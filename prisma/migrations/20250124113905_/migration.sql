...
INSERT INTO "new_student_discipline" ("created_at", "disciplineId", "id", "status", "student_id", "updated_at") SELECT "created_at", "disciplineId", "id", "status", "student_id", "updated_at" FROM "student_discipline";
